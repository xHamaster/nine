...
keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(text="• Mᴇɴᴜ", callback_data="set_pause"),
                InlineKeyboardButton(text="• Cʟᴏsᴇ", callback_data="set_resume"),
            ],[
                InlineKeyboardButton(text="• Mᴇɴᴜ", callback_data="set_stop"),
                InlineKeyboardButton(text="• Cʟᴏsᴇ", callback_data="set_resume"),
            ]
        ]
    )
